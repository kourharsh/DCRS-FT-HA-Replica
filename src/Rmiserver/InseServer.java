...
public class InseServer {
	   ...
	   public static void startInseServer() throws RemoteException, MalformedURLException {
			try {
				Runnable task = () -> {
					receive();
				};
				...
				thread.start();
	//			fileTxt = new FileHandler("C:\\Users\\WEB\\eclipse-workspace\\CORBA\\Log files\\InseServer.log");
				fileTxt = new FileHandler("G:\\workspace\\Logfile\\InseServer.log");
...
*/			//	CommonServer.startRegistry(RMIPort);
	...
	public static String listCourse2(String semester) {
