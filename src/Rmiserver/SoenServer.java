...
public class SoenServer {
	...
	//	static String semReceived;
	   ...
	   public static void startSoenServer() throws RemoteException, MalformedURLException {
			try {
				Runnable task = () -> {
					receive();
				};
				...
				thread.start();		
			//	fileTxt = new FileHandler("C:\\Users\\WEB\\eclipse-workspace\\CORBA\\Log files\\SoenServer.log");
				fileTxt = new FileHandler("G:\\workspace\\Logfile\\SoenServer.log");
			...
			/*    ORB orb = ORB.init(args, props); // create and initialize the ORB
	...
	public static String listCourse3(String semester) {
